...
class DialogueScene1 extends Phaser.Scene {
    ...
    create() {
        ...
        let dialogueData = [
            ...
            { speaker: "diplomat", side: "right",  text: "Nu putem fi siguri ca plănuiește un atac împotriva noastră." },
            ...
            { speaker: "samurai", side: "left",  text: "Înca deține armata, pământuri și alianțe." },
